# Generated by Django 2.1 on 2018-11-29 13:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0002_auto_20181129_2047'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apptestobjname', models.CharField(max_length=200, verbose_name='测试对象描述')),
                ...
                ('appassertresult', models.CharField(max_length=200, verbose_name='验证数据')),
                ('apptestresult', models.BooleanField(verbose_name='测试结果')),
                ('create_time', models.DateTimeField(auto_now=True, verbose_name='创建时间')),
